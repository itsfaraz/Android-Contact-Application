...
import com.itsfrz.authentication.ui.views.compose.ui.theme.BorderColor1
import com.itsfrz.authentication.ui.views.compose.ui.theme.Shapes
...
fun AlertBox(
    ...
    dialogVisibilityListener : (value : Boolean) -> Unit,
                    ...
                    Box(
                        ...
                        Card(
                            modifier = Modifier
                                ...
                                .size(20.dp)
                                .clickable {
                                    dialogVisibilityListener(false)
                                },
